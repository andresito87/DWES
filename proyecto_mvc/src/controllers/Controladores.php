...
use DWES04\exceptions\AuthException;
...
class Controladores
{
    ...
    {        
        ...
        $scenarios=
            [ AppException::DB_CONSTRAINT_VIOLATION_IN_QUERY => 'Ese producto ya era favorito.',              
        ...
        {            
            ...
            else $scenario=$scenarios['producto_desconocido'];                    
        }
        else $scenario=$scenarios['producto_no_facilitado'];  
    ...
    public static function removefromfav (Smarty $smarty)
    {
        ...
        {
            case 0: $scenario="No se ha borrado el producto favorito porque no estaba marcado como tal.";break;
            case 1: $scenario="Se ha borrado el producto favorito de la lista.";break;
        }
        $smarty->assign('resultado',$scenario);
