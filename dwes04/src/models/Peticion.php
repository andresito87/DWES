...
class Peticion
{
     ...
     * 
     * @param string $rootPath Raíz que se eliminará de la ruta. 
     * Por ejemplo, si la ruta completa es '/DWES04/test' y $basePath es '/DWES04' se retornará solo '/test'. 
     ...
     */
    public function getPath(string $rootPath = ''): string
    {
     ...
     * @return bool true si el método es GET, false en caso contrario.
     */
     ...
     * @return bool true si el método es POST, false en caso contrario.
     */
     ...
     * @return bool true si existen todos los parámetros y false en caso contrario.
     * 
     */
     ...
     * Peticion $p=new Peticion();
     * if ($p->has('a','b')) ...
     * @return mixed|null Retorna el valor del parámetro si existe, o null en caso contrario.
     */
     ...
     */
    public function getDouble($paramName, $locale = 'es_ES'): float
    {
     ...
     * @param bool $trim Si es true, se eliminan espacios anteriores y 
     * posteriores.
     * @return string
     ...
     * @param bool $trim Si se debe o no eliminar espacios antes y después de la cadena.
     * @return string cadena contenida el el parámetro.
     * @throws Exception si el parámetro no existe.
     */
    public function getString($name, $trim = true): string
    {
     ...
     * @param bool $trim si se limpia de espacios cada elemento del array
     * @return array[string]
     * @throws Exception Lanza una excepción si no existe el parámetro o 
     * si no es un array.
     */
    public function getArrayOfUnsafeStrings($name, $trim = true): array
    {
        if (!$this->has($name)) {
            throw new Exception("No existe $name.");
     ...
     * si no es un array.
     */
    public function getArrayOfStrings($name, $trim = true): array
    {
