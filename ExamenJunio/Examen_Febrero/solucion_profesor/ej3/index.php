...
session_start();
if (!isset($_SESSION['recuento'])) $_SESSION['recuento']=[];
...
if (is_string($texto))
{
    ...
    foreach($palabras as $palabra)
    {
        ...
        {
            if (!isset($_SESSION['recuento'][$tipo])) $_SESSION['recuento'][$tipo]=0;
            if (in_array($palabra,$listatipo)) $_SESSION['recuento'][$tipo]++;                           
        }
    }
} 
