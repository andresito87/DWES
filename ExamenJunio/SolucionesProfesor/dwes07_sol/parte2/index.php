...
<input type="button" onclick="<?=rq()->call('listarUbicaciones')?>" value="¡Actualizar lista de ubicaciones!">
...
<form id="nuevaUbicacion" onSubmit="return false;">
    ...
    <br>
    <input type="button"
        onclick="<?=rq()->call("nuevaUbicacion",pm()->form('nuevaUbicacion'));?>"
