...
<form action="?accion=crear_taller" method="post">
    <label>Nombre: 
        <input id="nombre" type="text" name="nombre" 
               value="{$datos.nombre|default:""|escape}">
    </label><BR>
    <label>Descripcion: 
        <input id="descripcion" type="text" name="descripcion" 
               value="{$datos.descripcion|default:""|escape}">
    </label><BR>
    <label>Ubicacion: 
        <input id="ubicacion" type="text" name="ubicacion" 
               value="{$datos.ubicacion|default:""|escape}">
    </label><BR>
    <label>                
        Día de la semana: 
    ...
    <label>Hora de inicio: 
        <input id="hora_inicio" type="text" name="hora_inicio" 
               value="{$datos.hora_inicio|default:""|escape}">
    </label><BR>
    <label>Hora de fin: 
        <input id="hora_fin" type="text" name="hora_fin" 
               value="{$datos.hora_fin|default:""|escape}">
    </label><BR>
    <label>Cupo máximo: 
        <input id="cupo_maximo" type="text" name="cupo_maximo" 
               value="{$datos.cupo_maximo|default:""|escape}">
    </label><BR>
