...
if (isset($_SESSION['auth'])) {
    ...
    if (isset($_SESSION['ultimo_acceso']) && (time() - $_SESSION['ultimo_acceso'] > MAXIMA_INACTIVIDAD)) {
        // Si ha pasado el tiempo de inactividad, destruye la sesión rediriendo al logout.php
    ...
    //Cualquier usuario que no esté autenticado, será redirigido al login.php
