...
if ($orden)
    $datos = ordenar($datos, $orden);

if ($categoria && is_array($datos))
    $datos = filtrar($datos, $categoria);
...
?>
<form action="" method="post">
    Columna Orden(Nombre,Fecha,Categoría): <input type="text" name="orden" value="<?= $orden ?>" id=""><BR>
