...
function usuarios(PDO $pdo, $activos=true, $filtro=""): array|int
{
    ...
    ENDSQL;
    return doSQL ($pdo,$sql,['activo'=>$activos?1:0,'filtro'=>"%$filtro%"]);
}
...
function detalle(PDO $pdo, $id)
{
    ...
    ENDSQL;
    return doSQL ($pdo,$sql,data:['id'=>$id],fetchFirst:true);
}
