...
$url=SERVER_URI.'post.php';
if (isset($resultado) && $resultado->estado=="AUTH_OK" || $resultado->estado=='READY')
{
    $datosNuevoMonumento=[
        'provincia'=>'Almería',
        'nombre'=>'El cable inglés',
        'latitud'=>36.83291439124473,
        'longitud'=>-2.458332716320346
    ];
    $options=['cookies'=>$jar,'json'=>$datosNuevoMonumento];    
    $response = $clienteHTTP->post($url,$options);  
